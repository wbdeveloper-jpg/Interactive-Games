...
public class SimpleLoader : MonoBehaviour
{
    ...
    private IEnumerator IntroSequence()
    {
        ...
        // Reset the score/time after intro, but do NOT start counting yet.
        if (gameManager != null)
        {
        ...
        // At this point every gameplay object/control is visible and ready.
        // Now show Tap To Start, then start both timers only after the tap.
    ...
    private IEnumerator RevealControls()
    {
        ...
        if (cg == null)
        {
            cg = controlsUI.AddComponent<CanvasGroup>();
        }
